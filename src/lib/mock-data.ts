...
export const mockMcqSetC: MCQ[] = [
  { id: 'mcq-c-1', question: 'Which data structure uses FIFO principle?', options: ['Stack', 'Queue', 'Tree', 'Heap'], correctAnswerIndex: 1 },
...
**Requirements:**
- Fix the missing colons in the class method definitions and conditions.
- Ensure the 'Enter Your Name' part correctly displays the account holder.
- The initial balance is 1000. Perform a deposit of 500 and a withdrawal of 300.
`,
  ...
  },
  {
    ...
    language: 'python',
    problemStatement: `Manage a list of available library books. Fix the conditional logic syntax errors.

**Requirements:**
- Fix missing colons in 'if' and 'else' blocks.
- The system should allow borrowing and returning books.
- Final available books list must be accurate.
`,
  ...
  },
  {
    ...
    language: 'java',
    problemStatement: `Calculate student grades based on marks. Fix the syntax and formatting issues.

**Requirements:**
- Fix missing semicolons after array initialization and print statements.
- Ensure the grades are correctly assigned: A (>=90), B (>=75), C (otherwise).
`,
